...
class TodoPageComponent extends React.Component<ITodoProps, ITodoState> {
                                ...
                                <Button
                                    ...
                                    onClick={() => {
                                        ...
                                        if (this.props.actions) {
                                            this.props.actions.completeTodoAction(
                                                record
                                            );
                                        }
                                    }}
    ...
    private handleOk = () => {
        ...
        if (this.props.actions) this.props.actions.addTodoAction(item);
...
// export const TodoPage = connect<ITodoProps>(mapStateToProps(), )
